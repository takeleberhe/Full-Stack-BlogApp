...
const app = express();
app.use(cors({ credentials: true, origin: "http://localhost:5173" })); //allow port 3000 client react app runs which is the allowed server to access our back-end server!
