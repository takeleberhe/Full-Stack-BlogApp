      ...
      <div className=" bg-slate-700 overflow-x-auto">
        <div className=" grid grid-cols-2 md:grid-cols-3 col-span-3">
          <div className="flex flex-col">
            <h2 className="mt-3 text-2xl text-black-900 hover:text-blue-700 cursor-pointer">
              About
            </h2>
          ...
          <div className="flex flex-col">
            <h2
              className="mt-3 text-2xl text-black-900 hover:text-blue-700
             cursor-pointer"
            >
              Services
            </h2>
          ...
          <div className="flex flex-col">
            <h2
              className="flex mt-3 text-2xl text-black-900 hover:text-blue-700 
            cursor-pointer"
            >
              Social Media
            </h2>
